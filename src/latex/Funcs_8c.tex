...
Interface explicita\+: string com a forma de abertura do arquivo \textquotesingle{}$\ast$type\textquotesingle{} e string com a opção de abertura \textquotesingle{}$\ast$opcao\textquotesingle{}
...
Interface explicita\+: primeira string para concatenação \textquotesingle{}$\ast$no\textquotesingle{}, segunda string para concatenação \textquotesingle{}$\ast$filho\textquotesingle{}
...
Interface explicita\+: número que identifica o tipo da pergunta \textquotesingle{}tipo\textquotesingle{}
